package com.subject.opencvdemo.Service;
...
public class FloatViewService extends Service {
    ...
    private void createFloatView() {
        ...
        //浮动窗口按钮
        mFloatView = (TextView) mFloatLayout.findViewById(R.id.tv_switch);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        mFloatView.setBackgroundResource(R.drawable.ic_launcher_background);
                        isClick = false;
                        break;
                    ...
                    case MotionEvent.ACTION_UP:
                        mFloatView.setBackgroundResource(R.drawable.ic_launcher_foreground);
